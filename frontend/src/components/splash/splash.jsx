        ...
        <div className="cta">Discover your cafe for today.</div>
          ...
          <div id="sf-available">
              *Currently available only in San Francisco <i class="fas fa-info-circle" aria-hidden="true" id="parent">
                <div id="popup">Sorry, we only support San Francisco locations at this moment. Feel free to explore some great San Francisco-based study areas! Zipcodes 94111 and 94109 have some neat cafes! </div>
              </i>
