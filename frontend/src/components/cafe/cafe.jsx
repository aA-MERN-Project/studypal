...
class Cafe extends React.Component {
  ...
  applyExtraFilters(cafes) {
    return cafes.filter(
      (cafe) => cafe.distance_away < this.props.filters.miles_away
    );
  }
  ...
  cafeClick(cafe) {
    ...
    this.props
      .fetchFavorites(this.props.user.id)
      .then(() => this.props.fetchCurrCafe(cafe.id))
      .then(() => this.props.openModal("cafeModal", "data"));
  ...
  render() {
    ...
    const sparePhoto = (
      <img className="photo" src="https://stockhome-app-seeds.s3-us-west-1.amazonaws.com/sparephoto.png"></img>
    );
        ...
        <div className="all">
          <div className="left-right">
            <div className="cafe">
              <div className="profile">
                <div className="title">
                  ...
                  <a
                    className="yelp"
                    onClick={() => {
                      this.cafeClick(this.props.yelpCafe);
                    }}
                  >
              ...
              {this.props.yelpCafe.image_url ? yelpPhoto : sparePhoto}
            </div>
